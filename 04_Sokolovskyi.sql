...
-- Розділяємо ім*я і прізвище працівників
ALTER TABLE Employee
ADD EmloyeeLastName nvarchar(50)

UPDATE Employee
SET EmloyeeLastName = RIGHT(EmployeeName, LEN(EmployeeName) - CHARINDEX(' ', EmployeeName))

UPDATE Employee
SET EmployeeName = LEFT(EmployeeName, CHARINDEX(' ', EmployeeName))
